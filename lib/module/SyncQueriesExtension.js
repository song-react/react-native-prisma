...
import { serializeJsonQuery } from '@prisma/client/runtime/react-native';
...
export const synchronousQueriesExtension = () => Prisma.defineExtension(client => client.$extends({
